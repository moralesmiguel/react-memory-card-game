...
2- You can see on the status how many pairs you've matched and how many turns you've used.

3- This game neither runs out of time nor do you play against an opponent. You simply try to beat your previous record.
...
To install the required modules before running "npm start".
